...
//             <TableRow >
//               <TableCell style={{ fontWeight: "bold", padding:"12px"}}>Module</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>ID</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Menu</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Page ID</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Name</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Y/N</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Inquiry</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Save</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Update</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Delete</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>App Y1</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>App Y2</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>App Y3</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>App Y4</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>App Y5</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>App Y6</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Print</TableCell>
//               <TableCell style={{ fontWeight: "bold", padding:"12px" }}>Excel</TableCell>
//             </TableRow>
//           </TableHead>
//           <TableBody>
//             {data
  ...
  return (
    <Box>
      ...
      <Box display="flex" justifyContent="flex-end" p={2}>
        <Button variant="contained" color="primary" onClick={updateUserAccess}>
          Update
        </Button>
      </Box>
      <TablePagination
